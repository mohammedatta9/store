                                            ...
                                            <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-badge">
                                                        <ul>
                                                            <li class="sale-badg">@if($property->type){{$property->type->name}}@endif</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="product-img-location">
                                                        <ul>
                                                            <li>
                                                                <a href="{{route('viewProperty',$property->id)}}"><i class="flaticon-pin"></i> @if($property->city){{$property->country->name}},{{$property->city->name}}@endif</a>
                                                            </li> 
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="product-info-bottom">
                                                    <div class="product-price">
                                                        <span>{{$property->price}} <label>@if($property->currency) {{$property->currency->name}} @endif</label> {{$property->price_description}}</span>  
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-12">
                                                                            <div class="modal-product-info">
                                                                                ...
                                                                                <div class="product-price">
                                                                                <span>{{$property->price}} <label>@if($property->type) {{$property->currency->name}}@endif </label> {{$property->price_description}}</span>  
                                                                                </div>
                                                                                <hr>
                                                                                ...
                                                                                <div class="modal-product-meta ltn__product-details-menu-1 d-none">
                                                                                    <ul>
                                                                                        <li>
                                                                                            <strong>@if($property->type){{$property->type->name}}@endif</strong>
                                                                                ...
                                                                                <div class="ltn__product-details-menu-3">
                                                                                    <ul>
                                                                                        <li>
                                                                                                ...
                                                                                                <span>@if($property->type){{$property->type->name}}@endif</span>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                            ...
                                            <div class="product-info">
                                                <div class="product-badge-price">
                                                    ...
                                                    <div class="product-price">
                                                        <span>{{$property->price}} @if($property->currency){{$property->currency->name}}@endif<label>/{{$property->price_description}}</label></span>
                                                    </div>
                                                </div>
                                                <h2 class="product-title"><a href="{{route('viewProperty',$property->id)}}">{{$property->title}}</a></h2>
                                                <div class="product-img-location">
                                                    <ul>
                                                        <li>
                                                            <a href="locations.html"><i class="flaticon-pin"></i>@if($property->city){{$property->country->name}} , {{$property->city->name}}@endif</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
