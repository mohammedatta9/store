                                    ...
                                    <div class="tab-pane p-3 active" id="Post" role="tabpanel">
                                      ...
                                      <input   type="text" name="id" value="{{$product->id}}"  style="display:none;">
                                        ...
                                        @error('name')
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="name" type="text" value="{{$product->name}}" id="example-text-input"  maxlength="100">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        @error('description')
                                            ...
                                            <div class="col-sm-9">
                                            <textarea class="form-control" name="description" rows="5" maxlength="300" >{{$product->description}} </textarea>                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        @error('price')
                                            <small class="form-text text-danger">{{$message}}</small>
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="price" type="number"  maxlength="100" value="{{$product->price}}"   >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="price_alternative"  maxlength="100" value="{{$product->price_alternative}} " id="example-text-input">
                                            </div>
                                        </div>
                                        <!-- <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            @enderror
                                                <select class="form-control"  name="category_id">
                                                     ...
                                                     @if( $product->category )
                                                     <option value="{{$product->category_id}} " selected>{{$product->category->name}} </option>@endif
                                            
                                                     <option value="12">   اختر قسم  </option>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="quantity" type="number"  maxlength="100" value="{{$product->quantity}}" >
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label   class="col-sm-3 col-form-label text-end">رمز السلعة</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" name="code" id="cood" type="text"  maxlength="100" value="{{$product->code}} " >
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
